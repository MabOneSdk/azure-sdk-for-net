...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    internal partial class VaultExtendedInfoOperations : IServiceOperations<RecoveryServicesClient>, IVaultExtendedInfoOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<VaultExtendedInfoResource>> PatchWithHttpMessagesAsync(string resourceGroupName, string vaultName, VaultExtendedInfoResource resourceResourceExtendedInfoDetails, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
