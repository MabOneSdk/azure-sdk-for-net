...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    internal partial class RegisteredIdentitiesOperations : IServiceOperations<RecoveryServicesClient>, IRegisteredIdentitiesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string vaultName, string resourceGroupName, string identityName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
