...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    internal partial class ReplicationUsagesOperations : IServiceOperations<RecoveryServicesClient>, IReplicationUsagesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ReplicationUsage>>> ListWithHttpMessagesAsync(string vaultName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
