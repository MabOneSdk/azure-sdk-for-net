...
namespace Microsoft.Azure.Management.RecoveryServices
{
    ...
    internal partial class VaultCertificatesOperations : IServiceOperations<RecoveryServicesClient>, IVaultCertificatesOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ResourceCertificateDetailsResource>> UploadWithHttpMessagesAsync(string vaultName, string resourceGroupName, string certificateName, CertificateRequest certificateRequest, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<ResourceCertificateDetailsResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<ResourceCertificateDetailsResource>(_responseContent, Client.DeserializationSettings);
                }
