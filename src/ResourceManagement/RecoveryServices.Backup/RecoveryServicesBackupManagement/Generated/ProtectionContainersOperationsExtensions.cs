...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
   ...
   using Models;
    ...
    public static partial class ProtectionContainersOperationsExtensions
    {
            ...
            /// </param>
            public static void Unregister(this IProtectionContainersOperations operations, string vaultName, string resourceGroupName, string identityName)
            {
                System.Threading.Tasks.Task.Factory.StartNew(s => ((IProtectionContainersOperations)s).UnregisterAsync(vaultName, resourceGroupName, identityName), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None,  System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task UnregisterAsync(this IProtectionContainersOperations operations, string vaultName, string resourceGroupName, string identityName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
                await operations.UnregisterWithHttpMessagesAsync(vaultName, resourceGroupName, identityName, null, cancellationToken).ConfigureAwait(false);
            }
