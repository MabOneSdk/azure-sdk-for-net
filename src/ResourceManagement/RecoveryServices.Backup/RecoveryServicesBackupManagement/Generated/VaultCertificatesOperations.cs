...
namespace Microsoft.Azure.Management.RecoveryServices.Backup
{
    ...
    /// </summary>
    internal partial class VaultCertificatesOperations : Microsoft.Rest.IServiceOperations<RecoveryServicesBackupClient>, IVaultCertificatesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal VaultCertificatesOperations(RecoveryServicesBackupClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async System.Threading.Tasks.Task<Microsoft.Rest.Azure.AzureOperationResponse<ResourceCertificateDetailsResource>> UploadWithHttpMessagesAsync(string vaultName, string resourceGroupName, string certificateName, CertificateRequest certificateRequest, System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<string>> customHeaders = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (vaultName == null)
            {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "certificateRequest");
            }
            ...
            // Create Result
            var _result = new Microsoft.Rest.Azure.AzureOperationResponse<ResourceCertificateDetailsResource>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<ResourceCertificateDetailsResource>(_responseContent, this.Client.DeserializationSettings);
                }
