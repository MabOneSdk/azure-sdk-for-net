...
namespace Microsoft.Azure.Management.RecoveryServices.Backup.Models
{
    ...
    public partial class JobQueryObject
    {
        ...
        /// UTC.</param>
        public JobQueryObject(JobStatus? status = default(JobStatus?), string backupManagementType = default(string), JobOperationType? operation = default(JobOperationType?), string jobId = default(string), System.DateTime? startTime = default(System.DateTime?), System.DateTime? endTime = default(System.DateTime?))
        {
            Status = status;
